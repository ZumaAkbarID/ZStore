...
<body>
    ...
    <div class="topbar-image bg-primary py-1 rounded-0 mb-0 alert alert-dismissible fade show" role="alert">
        <div
            ...
            <span class="badge bg-white bg-opacity-10 fs-2 fw-bolder px-2">{{ __('message.alert') }}</span>
            <p class="mb-0 text-white fw-bold">{{ __('message.under development') }}</p>
        </div>
    ...
    <header class="header-fp p-0 w-100">
        <nav class="navbar navbar-expand-lg bg-primary-subtle py-2 py-lg-10">
            <div class="custom-container d-flex align-items-center justify-content-between">
                <a href="{{ route('frontend.index') }}" class="text-nowrap logo-img">
                    ...
                    <ul class="navbar-nav mx-auto mb-2 gap-xl-7 gap-8 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link fs-4 fw-bold text-dark link-primary"
                                href="../main/frontend-aboutpage.html">{{ __('menu.About Us') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fs-4 fw-bold text-dark link-primary d-flex gap-2"
                                ...
                                {{ __('menu.Blog') }}
                                <span
                                    class="badge text-primary bg-primary-subtle fs-2 fw-bolder hstack">{{ __('menu.Soon') }}</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fs-4 fw-bold text-dark link- d-flex gap-2" href="{{ route('404') }}">
                                {{ __('menu.Topup Game') }}
                                <span
                                    class="badge text-primary bg-primary-subtle fs-2 fw-bolder hstack">{{ __('menu.Soon') }}</span>
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link fs-4 fw-bold text-dark link-primary"
                                href="{{ route('404') }}">{{ __('menu.Contact') }}</a>
                        </li>
                    </ul>
                    <div>
                        <a href="{{ route('404') }}" class="btn btn-primary py-8 px-9">Log In</a>
                    </div>
                </div>
            </div>
        </nav>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header">
            <a href="{{ route('frontend.index') }}">
                <img src="{{ url('/') }}/assets/images/logos/dark-logo.png" alt="Logo-light" />
            </a>
        ...
        <div class="offcanvas-body">
            <ul class="list-unstyled ps-0">
                <li class="mb-1">
                    <a href="{{ route('404') }}" class="px-0 fs-4 d-block text-dark link-primary w-100 py-2">
                        {{ __('menu.About Us') }}
                    </a>
                </li>
                ...
                <li class="mb-1">
                    <a href="{{ route('404') }}" class="px-0 fs-4 d-block w-100 py-2 text-dark link-primary">
                        {{ __('menu.Contact') }}
                    </a>
                </li>
                <li class="mt-3">
                    <a href="{{ route('404') }}" class="btn btn-primary w-100">Log In</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="custom-container">
                ...
                <div class="row align-items-end mb-3">
                    <div class="col-lg-3 d-none d-lg-block">
                        <img src="{{ url('/') }}/assets/images/frontend-pages/banner-top-left.svg"
                            class="ms-n2 w-100" alt="banner-top-left">
                    </div>
                    <div class="col-lg-6">
                        ...
                        <div
                            ...
                            <a class="d-flex align-items-center justify-content-center bg-white rounded-3 round-54 shadow"
                                ...
                                <img src="{{ url('/') }}/assets/images/frontend-pages/icon-bootstrap.svg"
                                    width="28" height="28" alt="icon" />
                            </a>
                            <a class="d-flex align-items-center justify-content-center bg-white rounded-3 round-54 shadow"
                                href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-title="Sass">
                                <img src="{{ url('/') }}/assets/images/frontend-pages/icon-sass.svg"
                                    width="28" height="28" alt="icon" />
                            </a>
                            <a class="d-flex align-items-center justify-content-center bg-white rounded-3 round-54 shadow"
                                href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-title="Gulp">
                                <img src="{{ url('/') }}/assets/images/frontend-pages/icon-gulp.svg"
                                    width="28" height="28" alt="icon" />
                            </a>
                            <a class="d-flex align-items-center justify-content-center bg-white rounded-3 round-54 shadow"
                                href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-title="Figma">
                                <img src="{{ url('/') }}/assets/images/frontend-pages/icon-figma.svg"
                                    width="24" height="24" alt="icon" />
                            </a>
                            <a class="d-flex align-items-center justify-content-center bg-white rounded-3 round-54 shadow"
                                href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-title="Apexchart">
                                <img src="{{ url('/') }}/assets/images/frontend-pages/icon-apexchart.svg"
                                    width="24" height="24" alt="icon" />
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-3 d-none d-lg-block">
                        <img src="{{ url('/') }}/assets/images/frontend-pages/banner-top-right.svg"
                            class="me-n2 w-100" alt="banner-top-right">
                    </div>
                </div>
                <div class="row d-none d-lg-block">
                    <div class="col-12">
                        <img src="{{ url('/') }}/assets/images/frontend-pages/bottom-part.svg" alt="screenshots"
                            class="w-100">
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-6 col-lg-4">
                        <div class="card shadow-none bg-warning-subtle rounded-24">
                            <div class="card-body text-center py-14">
                                <img src="{{ url('/') }}/assets/images/frontend-pages/icon-briefcase.svg"
                                    alt="icon">
                        ...
                        <div class="card shadow-none bg-secondary-subtle rounded-24">
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="{{ url('/') }}/assets/images/frontend-pages/playframe.png"
                                    alt="icon">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 order-last order-lg-0">
                        <div class="card shadow-none bg-primary-subtle rounded-24">
                            <div class="card-body text-center py-14 px-3">
                                <img src="{{ url('/') }}/assets/images/logos/favicon.png" alt="icon">
                                ...
                                <img src="{{ url('/') }}/assets/images/frontend-pages/screen.png" alt="icon"
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card shadow-none bg-secondary-subtle rounded-24">
                            <div class="card-body text-center py-14">
                                <img src="{{ url('/') }}/assets/images/frontend-pages/icon-speech-bubble.svg"
                                    alt="icon">
                        ...
                        <div class="card shadow-none bg-danger-subtle rounded-24">
                            <div class="card-body text-center pt-14 pb-5 mb-8">
                                <img src="{{ url('/') }}/assets/images/frontend-pages/icon-favorites.svg"
                                    alt="icon">
                            ...
                            <div class="row gap-lg-0 gap-7">
                                <div class="col-lg-6">
                                    <div class="bg-primary-subtle rounded-3 px-10 pt-5 pb-4">
                                        <img src="{{ url('/') }}/assets/images/frontend-pages/tabsimage.png"
        ...
        <section class="py-5 py-md-14 py-lg-12">
            <div class="container-fluid">
                ...
                <div class="owl-carousel leadership-carousel owl-theme mt-5">
                    <div class="item">
                        <div class="">
                            <img src="{{ url('/') }}/assets/images/frontend-pages/alex.jpg" alt="leader"
                                class="rounded-3">
                            <div
                    ...
                    <div class="item">
                        <div class="">
                            <img src="{{ url('/') }}/assets/images/frontend-pages/jordan.jpg" alt="leader"
                                class="rounded-3">
                            <div
                                class="position-relative leadership-card z-1 bg-white mt-n10 rounded py-3 px-8 mx-9 text-center shadow-sm">
                    ...
                    <div class="item">
                        <div class="">
                            <img src="{{ url('/') }}/assets/images/frontend-pages/taylor.jpg" alt="leader"
                                class="rounded-3">
                            <div
                                class="position-relative leadership-card z-1 bg-white mt-n10 rounded py-3 px-8 mx-9 text-center shadow-sm">
                    ...
                    <div class="item">
                        <div class="">
                            <img src="{{ url('/') }}/assets/images/frontend-pages/morgan.jpg" alt="leader"
                                class="rounded-3">
                            <div
                                class="position-relative leadership-card z-1 bg-white mt-n10 rounded py-3 px-8 mx-9 text-center shadow-sm">
                    ...
                    <div class="item">
                        <div class="">
                            <img src="{{ url('/') }}/assets/images/frontend-pages/kiana.jpg" alt="leader"
                                class="rounded-3">
                            <div
                                class="position-relative leadership-card z-1 bg-white mt-n10 rounded py-3 px-8 mx-9 text-center shadow-sm">
                                <h4 class="fs-5 fw-semibold mb-2">Morgan Patel</h4>
                        ...
                        <div class="owl-carousel template-carousel owl-theme">
                            <div class="item rounded overflow-hidden">
                                <a target="_blank" href="../main/index.html">
                                    <img src="{{ url('/') }}/assets/images/demos/demo-main.jpg" alt="template">
                                </a>
                            </div>
                            <div class="item rounded overflow-hidden">
                                <a target="_blank" href="../dark/index.html">
                                    <img src="{{ url('/') }}/assets/images/demos/demo-dark.jpg" alt="template">
                                </a>
                            </div>
                            <div class="item rounded overflow-hidden">
                                <a target="_blank" href="../horizontal/index.html">
                                    <img src="{{ url('/') }}/assets/images/demos/demo-horizontal.jpg"
                                        alt="template">
                                </a>
                            </div>
                            <div class="item rounded overflow-hidden">
                                <a target="_blank" href="../minisidebar/index.html">
                                    <img src="{{ url('/') }}/assets/images/demos/demo-minisidebar.jpg"
                                        alt="template">
                                </a>
                            </div>
                            <div class="item rounded overflow-hidden">
                                <a target="_blank" href="../rtl/index.html">
                                    <img src="{{ url('/') }}/assets/images/demos/demo-rtl.jpg" alt="template">
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5">
                        <div class="">
                            <h2 class="fs-10 fw-bolder mb-3">
                                What our clients
                                <br /> think
                                <img src="{{ url('/') }}/assets/images/logos/favicon.png" alt="icon"> about
                                us?
                            </h2>
                            <p class="fs-4">
                            ...
                            <div class="owl-carousel testimonial-carousel owl-theme">
                                <div class="item">
                                    <div>
                                        <div class="d-flex align-items-center gap-3 my-4">
                                            <div>
                                                <img src="{{ url('/') }}/assets/images/frontend-pages/user_1.png"
                                                    width="56" height="56" alt="user">
                                            </div>
                                ...
                                <div class="item">
                                    <div>
                                        <div class="d-flex align-items-center gap-3 my-4">
                                            <div>
                                                <img src="{{ url('/') }}/assets/images/frontend-pages/user-2.png"
                                                    width="56" height="56" alt="user">
                                            </div>
                                ...
                                <div class="item">
                                    <div>
                                        <div class="d-flex align-items-center gap-3 my-4">
                                            <div>
                                                <img src="{{ url('/') }}/assets/images/frontend-pages/user-3.png"
                                                    width="56" height="56" alt="user">
                                            </div>
                            ...
                            <div class="card p-7 mb-0 rounded-3 border">
                                ...
                                <div class="my-sm-7 my-3 d-flex flex-column gap-3">
                                    <div class="d-flex gap-2">
                                        <img src="{{ url('/') }}/assets/images/frontend-pages/icon-circle-check.svg"
                                            alt="">
                                    ...
                                    <div class="d-flex gap-2">
                                        <img src="{{ url('/') }}/assets/images/frontend-pages/icon-circle-x.svg"
                                            alt="">
                            ...
                            <div class="col-lg-10">
                                <div class="d-flex align-items-center justify-content-between gap-4 flex-wrap">
                                    <a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="top"
                                        data-bs-title="Visa">
                                        <img src=" {{ url('/') }}/assets/images/frontend-pages/visa.png"
                                            alt="visa">
                                    </a>
                                    <a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="top"
                                        data-bs-title="Mastercard">
                                        <img src="{{ url('/') }}/assets/images/frontend-pages/mastercard.png"
                                            alt="mastercard">
                                    </a>
                                    <a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="top"
                                        data-bs-title="Americanexpress">
                                        <img src="{{ url('/') }}/assets/images/frontend-pages/americanexpress.png"
                                            alt="americanexpress">
                                    </a>
                                    <a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="top"
                                        data-bs-title="Paypal">
                                        <img src="{{ url('/') }}/assets/images/frontend-pages/paypal.png"
                                            alt="paypal">
                                    </a>
                                    <a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="top"
                                        data-bs-title="Maestro">
                                        <img src="{{ url('/') }}/assets/images/frontend-pages/maestro.png"
                                            alt="maestro">
                                    </a>
                                    <a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="top"
                                        data-bs-title="JCB">
                                        <img src="{{ url('/') }}/assets/images/frontend-pages/jcb.png"
                                            alt="jcb">
                                    </a>
                                    <a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="top"
                                        data-bs-title="Dinersclub">
                                        <img src="{{ url('/') }}/assets/images/frontend-pages/dinersclub.png"
                                            alt="dinersclub">
                                    </a>
                                    <a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="top"
                                        data-bs-title="Discover">
                                        <img src="{{ url('/') }}/assets/images/frontend-pages/discover.png"
                                            alt="discover">
                                    </a>
                                </div>
                            </div>
                ...
                <div class="bg-primary-subtle rounded-3 position-relative overflow-hidden">
                    <div class="row">
                        ...
                        <div class="col-lg-6 d-lg-block d-none">
                            <img src="{{ url('/') }}/assets/images/frontend-pages/design-collection.png"
                                alt="banner" class="position-absolute develop-feature-rich">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-3 col-6">
                        ...
                        <div class="d-flex gap-9">
                            <a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-title="Facebook">
                                <img src="{{ url('/') }}/assets/images/frontend-pages/icon-facebook.svg"
                                    alt="facebook">
                            </a>
                            <a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-title="Twitter">
                                <img src="{{ url('/') }}/assets/images/frontend-pages/icon-twitter.svg"
                                    alt="twitter">
                            </a>
                            <a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-title="Instagram">
                                <img src="{{ url('/') }}/assets/images/frontend-pages/icon-instagram.svg"
                                    alt="instagram">
                            </a>
                        </div>
                    </div>
    ...
    <script src="{{ url('/') }}/assets/js/frontend-landingpage/homepage.js"></script>
</body>
