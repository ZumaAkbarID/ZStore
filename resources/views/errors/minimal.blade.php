                ...
                <div class="row justify-content-center w-100">
                    <div class="col-lg-4">
                        <div class="text-center">
                            <img src="@yield('image')" class="img-fluid" width="500">
                            <h1 class="fw-semibold mb-7 fs-9">@yield('code')</h1>
                            <h4 class="fw-semibold mb-7">@yield('message')</h4>
                            <a class="btn btn-primary" href="{{ route('frontend.index') }}"
                                role="button">{{ __('Go Back to Home') }}</a>
                        </div>
                    </div>
                </div>
            </div>
